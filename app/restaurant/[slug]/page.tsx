            ...
            <div className="w-[27%] relative text-reg">
              <div className="fixed w-[15%] bg-white rounded p-3 shadow">
                <div className="text-center border-b pb-2 font-bold">
                  <h4 className="mr-7 text-lg text-black">
                    Make a Reservation
                  </h4>
                </div>
                <div className="my-3 flex flex-col">
                  ...
                  <select
                    name=""
                    className="py-3 border-b font-light text-black"
                    id=""
                  >
                ...
                <div className="mt-5">
                  <button className="bg-red-600 rounded w-full px-4 text-black font-bold h-16 ">
                    Find a Time
                  </button>
                </div>
              </div>
